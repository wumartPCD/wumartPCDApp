...
@implementation BaseRptMenuController
...
- (void)launch:(int)index{
    ...
    for (int i = 0; i < menusArr.count; i++) {
        ...
        [itemArr addObject: [GridMenuItemView initWithTitle:menu.MenuID title:menu.MenuName imgName:imageName uiCtrl:mainCtrl]];
    }
