...
@implementation RTSaleSnapReportsTopController
...
- (void)viewDidLoad
{
    ...
    //菜单栏,首页
    slideMenuController = [[RTSaleSnapSlideMenuController alloc]init];
    
    rtSaleController = [[RTSaleSnapReportsController alloc]init];
    keyMerchController = [[RTKeyMerchSnapController alloc]init];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    NSString *evnName=@"RTSaleSnapReportsTopController.showSlideMenuView";
